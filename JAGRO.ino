...
void sync(){
  ...
  //This will trigger Mission Control to send relay commands
  //containing the most recent relay state
  client.publish("jagro/JAGRO2/sync", "0");
  Serial.println("Syncronising...");
  NEED_SYNC = false;
}
